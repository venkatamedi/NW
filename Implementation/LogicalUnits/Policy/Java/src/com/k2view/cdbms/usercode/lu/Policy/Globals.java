...
package com.k2view.cdbms.usercode.lu.Policy;
...
public class Globals extends SharedGlobals {
	...
	@category("TDM")
	public static final String ROOT_TABLE_NAME = "PLCY_PRD";
	...
	@category("TDM")
	public static final String ROOT_COLUMN_NAME = "ACCT_NBR";

	public static String SCHEMA_NAME = "MBPT";
