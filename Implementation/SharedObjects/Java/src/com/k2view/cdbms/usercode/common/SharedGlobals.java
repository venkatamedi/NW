...
public class SharedGlobals {
	...
	@desc("The interface of the DB on which DBExecute, DBQuery ... will run")
	@category("MASKING")
	public static final String DB_INTERFACE_NAME = "ludb";
	@desc("Date format")
	@category("MASKING")
	public static final String DATE_FORMAT = "yyyy-MM-dd";
	@desc("random encryption indication")
	@category("MASKING")
	public static final String RANDOM_ENCRYPTION = "RANDOM";
	@desc("Determines if to convert a single apostrophe to double apostrophe.")
	@category("MASKING")
	public static final String REPLACE_APOSTROPHE_FLAG = "1";
	@desc("Indicates if flag is enabled")
	@category("MASKING")
